...
Doslovan prijepis. Rečenica koja je ovdje je Blobbyjeva; sve ostalo u datotekama lekcija nije.
...
## Vocabulary 1
- Your first Croatian flashcard deck — every word sounds exactly as it's written. Tap to reveal meaning & pronunciation.
- You just met them — now catch them! Tap the English meaning before the timer runs out.
- One word, one card. How the endings change is Grammar's job — here just learn the words.
...
- **One exception worth knowing.** *Auto* ends in **-o**, but it is masculine. There are only a handful like it.

## Practice 1
- Time to read real Croatian!

---

## Lesson 2
- In Lesson 1 you described houses and coffee. Now it's time to talk about *people* — including yourself.
- One verb, six forms — and you already know one of them:
- Spot the pattern: *student* is a man, *studentica* is a woman. Same with *profesor/profesorica*, *doktor/doktorica*. Croatian loves this **-ica** ending.
- Odlično! You can now introduce yourself, describe people, and handle the most important verb in Croatian.

## Vocabulary 2
- Everything you need to talk about people, starting with yourself. Tap to reveal.
- The most important verb in Croatian.
- The final round mixes this lesson with everything from Lesson 1 — how much do you remember?

## Grammar 2
- Here's the complete map of the verb you've been using — the most important verb in Croatian.
- When in doubt in Croatia: start with **vi** — locals will offer you *ti* quickly.

## Practice 2
- Four people introduce themselves. See how far you get before you tap EN.

---

## Lesson 3
- So far you can *describe* the world: the coffee is good, the day is beautiful. Now you'll make things *happen* in it.
- And notice something: you often don't even need *ja*. The verb ending already tells everyone who's doing it. Efficient, right?
- The ending is the name tag: **-m** = me, **-š** = you, no extra ending = he/she. It works the same for *piti* (pijem, piješ, pije) and *jesti* (jedem, jedeš, jede) — the middle changes a bit, but the endings never lie.
- Sjajno! You can now say what you and others are doing — and you've cracked the verb-ending code that runs the whole language.

## Vocabulary 3
- Nine verbs that cover most of your day. Tap to reveal.

## Grammar 3
- In Lesson 3 your ear learned the endings. Here's the system behind them.
- **Drop the pronoun:** the ending already says who. *Pijem sok.* = *Ja pijem sok.* — both correct, the short one more natural. Keep the pronoun only for emphasis: *JA pijem sok* (me, not you).
...
## Vocabulary 4
- Start with the people closest to you. Notice how many end in **-a** — Croatian family words are mostly short and warm.
...
## Vocabulary 5
- Every word here ends in **-a**, and every one of them turns that -a into **-u** the moment you drink it, eat it or buy it. Learn each one as a pair.

## Grammar 5
- **What a "case" is:** Croatian shows a word's *role* in the sentence by changing its ending.

## Practice 5
- Your accusative in action
...
## Vocabulary 6
- Living masculine nouns, each shown with its target form. Five of them squeeze a letter out on the way: **policajac → policajca**, **kupac → kupca**, **pas → psa**.

## Grammar 6
- Croatian likes to mark *who can be affected* by an action. Things can't care; beings can.
...
## Vocabulary 7
- Masculine nouns take **-i**. Watch the four where a **k** softens into **c** on the way: *učenik → učenici*.
...
## Vocabulary 8
- Croatia in summer, in one deck. **more** is the sea itself; going *na more* is what everyone says for "to the coast".
...
## Vocabulary 9
- Sport speaks Croatian with an accent you'll recognize instantly.

## Grammar 9
- The possessives are adjectives at heart — they agree with the *thing owned*, not the owner.
- English speakers: this is the one trap.

## Practice 9
- A club, a hobby, and a few people who take theirs seriously.

---

## Lesson 10
- You can describe, ask, plan and dream in Croatian. One thing is missing: telling stories. *What did you do yesterday?*
- Good news: the past tense recycles something you've known since Lesson 2 — the verb *biti*.
...
## Vocabulary 10
- Everything for telling stories about yesterday.
- The past participles — your storytelling toolkit.

## Grammar 10
- The participle shows the speaker's gender.

## Practice 10
- Your perfekt in the wild

---

## Lesson 11
- So far you've mostly been *telling* — now you'll start *asking*. Today's mission: buy the perfect birthday present.
- Seven little question words and one magic particle — **li** — and every conversation opens up.
- And the friendly tag at the end: *Voliš glazbu, **zar ne**?* — You like music, *don't you*?
- Izvrsno! You can now ask about anything — who, what, where, when, why and how. Conversations are officially two-way.

## Vocabulary 11
- Everything you need to ask and wonder.

## Grammar 11
- No question word? Use **li** — glue it right after the verb.

## Practice 11
- A present arrives, and nobody will say who sent it.

---

## Lesson 12
- You've been suspiciously agreeable for eleven lessons. Time to fix that.
- Today you learn to refuse soup, reject onions and declare that you *never* drink milk. Croatian negation is delightfully simple — one little word, **ne**, placed right before the verb. Plus two special verbs with attitude. Let's say no!
- English teachers hate this. Croatian grammar requires it. Enjoy the freedom.
- Bravo! You can now refuse, deny and protest — politely and grammatically.

## Vocabulary 12
- The complete toolkit for saying no — plus adjectives and cognates.

## Grammar 12
- In Croatian, negatives stack — and they *must*.

## Practice 12
- A family of picky eaters. Nobody agrees about dinner.
...
## Vocabulary 13
- Your map of the town, with the "being there" form on every card.

## Grammar 13
- Same endings, two jobs — the ending tells you whether you've arrived.
...
## Vocabulary 14
- Receivers with their dative form, plus the giving verbs.
...
- Today's case is the instrumental — the case of company and means. It's the last case of this module, and arguably the most social one.
...
## Vocabulary 15
- Friends, outings and ways to get there.
- Means of transport (no preposition!) and new verbs.

## Grammar 15
- The most common English-speaker mistake: "idem s vlakom" — you're not *accompanying* the train, you're *using* it. No s!
- Five down, two to go — you're past the hardest part.
...
## Vocabulary 16
- Grandma's world, with the genitive on every card.

## Grammar 16
- The genitive answers **koga? / čega?** — and it's Croatia's busiest case.
- **Case toolkit — complete!** Six of seven — only the vocative remains, and you've been using it in dialogues all along.
...
## Vocabulary 17
- Commands for recipes and directions — plus the soft "don't".
...
- Croatian dreams run on the **conditional**. The recipe is sweet and familiar: the past participle you know from Lesson 10 + a tiny new helper. Let's dream.
...
## Grammar 18
- **The politeness machine:** the conditional is Croatian's "please-mode".
- You'll hear it — but write *bismo/biste*; every teacher will thank you.
...
## Vocabulary 19
- Verb twins and the time words that go with them.

## Grammar 19
- Every Croatian verb carries a built-in answer to one question: *is the action complete?*
- **The homework trap:** one prefix, very different conversation.
...
## Vocabulary 20
- The vocabulary of memories — the last batch of the course!
- The final sprint of the course — tap the English meaning!

## Grammar 20
- Connectors for big thoughts.
