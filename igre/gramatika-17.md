...
- (prijatelju, nježno) | Nemoj gledati telefon! | Ne gledaj telefon!
- (grupi, nježno) | Nemojte trčati! | Ne trčite!
...
- Idemo na rijeku! | COMMAND
- Idemo na rijeku sutra. | STATEMENT
- Dodaj sol! | COMMAND
...
- tab: Verb | ja | ti | on / ona
- tab: moći (can) | **mogu** | **možeš** | **može**
- tab: morati (must) | **moram** | **moraš** | **mora**
- tab: htjeti (want) | **hoću** | **hoćeš** | **hoće**
...
- Dodajte sol! → | Možete li dodati sol
- Uzmi kartu! → | Možeš li uzeti kartu
...
- Možete li skrenuti lijevo na semaforu?
