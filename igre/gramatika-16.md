...
- djed → slika ___ | djeda
- žurba → nema ___ | žurbe

## Which case is it?
format: izbor
opis: The ending knows — which case is the bolded word?
- Pijem kavu bez šećera. — "šećera" je... | genitiv | dativ
- Šaljem pismo baki. — "baki" je... | dativ | genitiv
- Kupujem kavu. — "kavu" je... | akuzativ | genitiv
- Živim u gradu. — "gradu" je... | lokativ | instrumental

## Pick the preposition
format: izbor
opis: Choose the preposition.
- Kava ___ mlijeka, molim. | bez | iz | kod
- Putujem ___ Splita. | iz | bez | pokraj
- Večeras smo ___ bake. | kod | do | od
- ___ kuće je vrt. | Pokraj | Bez | Iz
...
- tab: 1 | nominative | jedn**a** kav**a**
- tab: 2, 3, 4 | genitive **singular** | dvije kav**e** · tri sok**a** · četiri pism**a**
- tab: 5 and up | genitive **plural** | pet kav**a** · deset sokov**a** · sto pisam**a**
...
- deset ___ | sokova | soka | sok
- ___ kave (two, feminine) | dvije | dva | dvoje
- ___ soka (two, masculine) | dva | dvije | dvoje
...
- kava (5) → pet ___ | kava
- sok (3) → tri ___ | soka
- sok (10) → deset ___ | sokova
- pismo (4) → četiri ___ | pisma
- sladoled (3) → tri ___ | sladoleda
