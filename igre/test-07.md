...
- roditelj | parent | relative | teacher
- knjiga | book | textbook | notebook
- udžbenik | textbook | book | report
...
- izvještaj | report | document | letter
...
- dosadan | boring | interesting | tired
- school | škola | razred | lekcija
- pupil | učenik | učitelj | dijete
- teacher | učitelj | učenik | roditelj
- boy | dječak | djevojčica | dijete
- girl | djevojčica | dječak | žena
- book | knjiga | udžbenik | torba
...
- dječaci | MIJENJA SE
- prozori | MIJENJA SE
- udžbenici | MIJENJA SE
- tramvaji | MIJENJA SE
- stolovi | MIJENJA SE
- roditelji | MIJENJA SE
- knjige | OSTAJE ISTO
- pisma | OSTAJE ISTO
- jabuke | OSTAJE ISTO
- pjesme | OSTAJE ISTO
- olovke | OSTAJE ISTO
- iskustva | OSTAJE ISTO
- mora | OSTAJE ISTO
...
- Prozori su ___ . | veliki | velike | velika
- Iskustva su ___ . | zanimljiva | zanimljivi | zanimljive
- Gradovi su ___ . | stari | stare | stara
- Olovke su ___ . | male | mali | mala
- Mora su ___ . | topla | topli | tople
- Udžbenici su ___ . | teški | teške | teška
- Djevojčice su ___ . | mlade | mladi | mlada
- Ocjene su ___ . | dobre | dobri | dobra
...
- Djeca ___ . (spavati) | spavaju
- Mi ___ knjige. (čitati) | čitamo
- Vi ___ film. (gledati) | gledate
- Učenici ___ tiho. (slušati) | slušaju
- Mi ___ klavir. (svirati) | sviramo
- Oni ___ kruh. (jesti) | jedu
- Vi ___ pismo. (pisati) | pišete
- Mi ___ hrvatski. (učiti) | učimo
- Djevojčice ___ . (plesati) | plešu
...
- udžbenici → Nosim ___ | udžbenike
- prozori → Gledam ___ | prozore
- tramvaji → Čekam ___ | tramvaje
- stolovi → Vidim ___ | stolove
