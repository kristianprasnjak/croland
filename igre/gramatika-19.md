...
## The rule: is the action finished?
format: tekst
...
- Svaki dan ___ kavu. | pijem | popijem
- Jučer sam ___ cijelu knjigu! | pročitao | čitao
- ___ je pismo cijelu večer. | Pisao | Napisao
- Sutra ću ___ poklon — odlučio sam! | kupiti | kupovati
...
- cijeli dan | PROCESS (imperfective)
- napokon | DONE (perfective)
- svaki dan | PROCESS (imperfective)
- odmah | DONE (perfective)
- polako | PROCESS (imperfective)
- za dvije minute | DONE (perfective)
- dugo | PROCESS (imperfective)
- dva puta | DONE (perfective)

## The rule: when the prefix isn't just aspect
format: tekst
...
- tab: Base | With prefix | Meaning
- tab: pisati (write) | **na**pisati | write and finish — pure aspect
- tab: pisati (write) | **pot**pisati | to sign
- tab: pisati (write) | **pre**pisati | to copy out
- tab: pisati (write) | **za**pisati | to note down
- tab: pisati (write) | **o**pisati | to describe
...
- napisati | TWIN (same meaning)
- potpisati | NEW VERB (new meaning)
- pročitati | TWIN (same meaning)
- prepisati | NEW VERB (new meaning)
- popiti | TWIN (same meaning)
- zapisati | NEW VERB (new meaning)
- pojesti | TWIN (same meaning)
- opisati | NEW VERB (new meaning)

## Which prefix?
format: izbor
opis: One base verb, five jobs. Pick the prefix the meaning needs.
- to sign a contract | potpisati | napisati | zapisati
- to write a letter and finish it | napisati | opisati | prepisati
- to note down a number | zapisati | potpisati | prepisati
- to describe a city | opisati | napisati | prepisati
- to copy out the text | prepisati | zapisati | potpisati

## Which command?
format: izbor
opis: Process or result — which one is the speaker asking for?
- Drink up your water, now! | Popij vodu! | Pij vodu!
- Drink water every day, it's healthy. | Pij vodu! | Popij vodu!
- Read the whole book — all of it! | Pročitaj knjigu! | Čitaj knjigu!
- Read a bit every evening. | Čitaj knjigu! | Pročitaj knjigu!
- Don't write! (gently) | Nemoj pisati! | Nemoj napisati! | Ne napiši!
