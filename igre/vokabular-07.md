...
- učenik → učenici | pupil
- učitelj → učitelji | teacher
- profesor → profesori | teacher, professor
- dječak → dječaci | boy
- prijatelj → prijatelji | friend
- udžbenik → udžbenici | textbook
...
- prozor → prozori | window
- roditelj → roditelji | parent
...
- pjesma → pjesme | song
- gitara → gitare | guitar
- lopta → lopte | ball
- godina → godine | year

## Neuter — -o or -e becomes -a
format: kartice
...
- dijete → djeca | child → children
- brat → braća | brother → brothers
- čovjek → ljudi | man → people
...
## Speed challenge: make it plural
format: brzina
