...
- jabuka | apple | pear | peach
- kruška | pear | apple | orange
- breskva | peach | strawberry | tomato
- jagoda | strawberry | peach | carrot
- naranča | orange | lemon | apple
...
- pita | pie | cake | bread
- torta | cake | pie | biscuit
- riža | rice | flour | sugar
- kruh | bread | cheese | cake
- sir | cheese | bread | milk
...
- jaje | egg | milk | meat
- meso | meat | fish | egg
- mlijeko | milk | water | wine
- povrće | vegetables | fruit | meat
- voće | fruit | vegetables | juice
- vino | wine | beer | juice
...
- trebati | to need | to want | to take
...
- ići | to go | to come | to walk
- svjež | fresh | expensive | sweet
- skup | expensive | cheap | tasty
- jeftin | cheap | expensive | fresh
- gladan | hungry | thirsty | tired
- žedan | thirsty | hungry | happy
- apple | jabuka | kruška | breskva
...
- juha | MIJENJA SE (-a → -u)
- riba | MIJENJA SE (-a → -u)
- torta | MIJENJA SE (-a → -u)
- kruška | MIJENJA SE (-a → -u)
- rajčica | MIJENJA SE (-a → -u)
- vrećica | MIJENJA SE (-a → -u)
- boca | MIJENJA SE (-a → -u)
- riža | MIJENJA SE (-a → -u)
- tržnica | MIJENJA SE (-a → -u)
- cijena | MIJENJA SE (-a → -u)
- kruh | OSTAJE ISTO
- sir | OSTAJE ISTO
- sok | OSTAJE ISTO
- limun | OSTAJE ISTO
- krumpir | OSTAJE ISTO
- sladoled | OSTAJE ISTO
- jaje | OSTAJE ISTO
- meso | OSTAJE ISTO
- mlijeko | OSTAJE ISTO
- voće | OSTAJE ISTO
...
- Kav___ je dobra. | The coffee is good. | a
...
- Čokolad___ je slatka. | The chocolate is sweet. | a
