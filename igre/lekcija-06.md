...
- policajac | MIJENJA SE (živo)
- turist | MIJENJA SE (živo)
- doktor | MIJENJA SE (živo)
- susjed | MIJENJA SE (živo)
- pas | MIJENJA SE (živo)
- tramvaj | OSTAJE ISTO (stvar)
- autobus | OSTAJE ISTO (stvar)
- vlak | OSTAJE ISTO (stvar)
- bicikl | OSTAJE ISTO (stvar)
- most | OSTAJE ISTO (stvar)
- trg | OSTAJE ISTO (stvar)
- semafor | OSTAJE ISTO (stvar)
- spomenik | OSTAJE ISTO (stvar)
- stol | OSTAJE ISTO (stvar)
- telefon | OSTAJE ISTO (stvar)
...
- Gledam ___ . | psa | pas
- Čekam ___ broj pet. | autobus | autobusa
- Turist fotografira ___ . | policajca | policajac
- Vidim ___ . | čovjeka | čovjek
- Fotografiram ___ . | most | mosta
- Marko čeka ___ . | doktora | doktor
- Vozim ___ . | auto | autoa
...
- Marko zove konobara.
- Čovjek gleda psa.
- Vidim autobus, ali čekam tramvaj.
- Turist fotografira spomenik.
- Policajac gleda promet.
- Vidim čovjeka i psa.
...
- Tko fotografira spomenik? | turist | konobar | policajac
- Zašto konobar zove turista? | jer kava čeka | jer je turist gladan | jer je promet velik
