...
- ___ automobil | star | stara | staro
...
- Restoran je nov/nova/novo. | nov
- Sunce je žut/žuta/žuto. | žuto
- Kava je topao/topla/toplo. | topla
- Grad je velik/velika/veliko. | velik
- Knjiga je star/stara/staro. | stara
...
- Krevet je velik___. | The bed is big. | -
...
- This isn't a book. | Ovo nije knjiga. | Ovo je knjiga. | Ovo ne je knjiga.
- The coffee isn't good. | Kava nije dobra. | Kava ne je dobra. | Kava nije dobar.
- The car isn't new. | Automobil nije nov. | Automobil nije nova. | Automobil ne je nov.
- The lamp isn't yellow. | Lampa nije žuta. | Lampa nije žut. | Lampa ne je žuta.
...
- More je plavo. → | More nije plavo
- Knjiga je nova. → | Knjiga nije nova
- Sladoled je hladan. → | Sladoled nije hladan
- Soba je mala. → | Soba nije mala
- Ovo je kuća. → | Ovo nije kuća
- Sunce je toplo. → | Sunce nije toplo
...
- The table is new. | Stol je nov. / Nov je stol.
...
- The coffee isn't good. | Kava nije dobra. / Nije dobra kava.
- The sea isn't cold. | More nije hladno. / Nije hladno more.
- This isn't a room. | Ovo nije soba.
