...
- s limunom | COMPANY (s/sa)
- biciklom | MEANS (no preposition)
- s prijateljem | COMPANY (s/sa)
...
- ona → Pjevam ___ | s njom
- mi → Dođi ___ | s nama
- oni → Treniram ___ | s njima

## Person or vehicle?
format: izbor
opis: Company takes s/sa. Means takes nothing. Which is it?
- Putujem ___ . (by train) | vlakom | s vlakom
- Idem u kino ___ . (with him) | s njim | njim
- Idemo ___ . (by bus) | autobusom | s autobusom
- Dođi ___ ! (with me) | sa mnom | s menom
- Ana putuje ___ . (with us) | s nama | nama
- Šećem ___ . (with the dog) | sa psom | psom
