...
- Nosim kišobran ___ pada kiša. | jer | iako | dok
- ___ bude vremena, doći ćemo. | Ako | Jer | Iako
- ___ je skup, restoran je uvijek pun. | Iako | Ako | Kad

## koji, koja, koje or koju?
format: izbor
opis: Match the relative pronoun.
- vlak ___ kreće u sedam | koji | koja
- riba ___ jedem | koju | koja
- dijete ___ pjeva | koje | koji
...
- Bude sunca. + Idemo na more. (ako) → | Ako bude sunca, idemo na more / Ako bude sunca idemo na more
- Ti spavaš. + Ja radim. (dok) → | Dok ti spavaš, ja radim / Dok ti spavaš ja radim
...
- Ostajem doma ___ pada kiša. | jer | da | dok
- Mislim ___ ćeš doći sutra. | da | kad | iako
- ___ bude sunca, idemo na rijeku. | Ako | Da | Jer
- Nadam se ___ je sve u redu. | da | jer | dok
- ___ je spor, vlak je ugodan. | Iako | Da | Ako
...
- knjiga ___ čitam | koju | koja | kojoj
- pjesma ___ je lijepa | koja | koju | kojoj

## Join it with da
format: upis
opis: Report the thought — join the halves with "da".
- Znam. + Zagreb je velik. → | Znam da je Zagreb velik
- Mislim. + Ti ćeš doći. → | Mislim da ćeš doći
- Nadam se. + Sve je u redu. → | Nadam se da je sve u redu
- Želim. + Ti dođeš. → | Želim da dođeš
- Rekao je. + Nema vremena. → | Rekao je da nema vremena
