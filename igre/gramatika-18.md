# The Conditional (Kondicional I)
cjelina: Grammar 18

## The rule: what would be
format: tekst
...
- Ja ___ putovao cijelu godinu. | bih
- Mi ___ ostali doma. | bismo
- Oni ___ došli na ručak. | bi
- Vi ___ gledali zvijezde. | biste

## The grammatical sentence
format: izbor
opis: Choose the grammatical sentence.
- swimming every day | Plivao bih svaki dan. | Bih plivao svaki dan.
- can't without coffee | Ne bih mogao bez kave. | Ne mogao bih bez kave.
- summer visits | Bi li dolazio ljeti? | Li bi dolazio ljeti?

## Past, future or dream?
format: razvrstavanje
stupci: PAST | FUTURE | CONDITIONAL
opis: Sort the sentences.
- Kupio sam kartu. | PAST
- Kupit ću kartu. | FUTURE
- Kupio bih kartu. | CONDITIONAL
- Plivali smo. | PAST
- Plivat ćemo. | FUTURE
- Plivali bismo. | CONDITIONAL

## The rule: putting a condition in front of the dream
format: tekst
- Lesson 18 gave you the dream. Here is the *if* that belongs in front of it — and Croatian keeps two of them apart.
- tab: Condition | Croatian | Reality
- tab: real, might happen | **Ako** imam vremena, doći ću. | possible
- tab: unreal, a dream | **Da** imam vremena, došao bih. | but I don't
...
- Da imam milijun eura, kupio bih brod. | SAN (da)
- Ako bude sunca, idemo na more. | MOGUĆE (ako)
- Da je ljeto, plivali bismo. | SAN (da)
- Ako padne kiša, ostat ćemo doma. | MOGUĆE (ako)
- Da znam hrvatski, živio bih u Splitu. | SAN (da)

## ako or da?
format: izbor
opis: The second half tells you which "if" the sentence needs.
- ___ bude sunca, ići ćemo na more. | Ako | Da
- ___ imam milijun eura, kupio bih brod. | Da | Ako
- ___ je ljeto, plivali bismo cijeli dan. | Da | Ako
- ___ padne kiša, ostat ćemo doma. | Ako | Da
- ___ znam hrvatski, živio bih u Splitu. | Da | Ako

## Finish the condition
format: upis
opis: One word — and it must agree with the half that follows.
- ___ imam vremena, doći ću. (possible) | Ako
- ___ imam vremena, došao bih. (a dream) | Da
- ___ bude lijepo, idemo na rijeku. (possible) | Ako
- ___ je more toplo, plivali bismo. (a dream) | Da

## Build the dream
format: slaganje
opis: Build the dream.
- Htjela bih živjeti pokraj mora.
- Što bi ti kupio s milijun eura?
- Zimi bismo čitali, a ljeti bismo plivali.
